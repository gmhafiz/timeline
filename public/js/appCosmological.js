...
// from -14,000,000,000 to -1,000,000
var container = document.getElementById('visualizationC');
...
var options = {
    ...
    max: "-000001-01-01", // 1 mya
    min: "-014000-01-01", // 14 bya
    showCurrentTime: false,
    zoomMin: 220752000000, // 1 year max zoom
...
jQuery(document).on('ready', function () {
    ...
    jQuery('form#addEvent').bind('submit', function (ev) {
        ...
        $.ajax({
            type: "POST",
            url: baseURL + "api/cosmologicalEvent",
            data: jsonData,
            dataType: "json",
    ...
    jQuery('form#getAllEvents').bind('submit', function (ev) {
        ...
        $.ajax({
            type: "GET",
            url: baseURL + "api/cosmologicalEvents",
            data: jsonData,
            dataType: "json",
            success: function (data) {
...
function updateEvent(itemObject) {
    ...
    $.ajax({
        type: "PUT",
        url: baseURL + "api/cosmologicalEvent/" + itemID,
        data: jsonData,
        dataType: "json",
        contentType: "application/json",
        success: function (data) {
...
function deleteItemDB(id) {
    $.ajax({
        type: "DELETE",
        url: baseURL + "api/cosmologicalEvent/" + id,
        data: null,
        dataType: "json",
        contentType: "application/json",
        success: function () {
