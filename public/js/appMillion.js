...
var container = document.getElementById('visualizationM');
...
function updateEvent(itemObject) {
    ...
    $.ajax({
        type: "PUT",
        url: baseURL + "api/millionEvent/" + itemID,
        data: jsonData,
        dataType: "json",
        contentType: "application/json",
        success: function (data) {
...
function deleteItemDB(id) {
    $.ajax({
        type: "DELETE",
        url: baseURL + "api/millionEvent/" + id,
        data: null,
        dataType: "json",
        contentType: "application/json",
        success: function () {
